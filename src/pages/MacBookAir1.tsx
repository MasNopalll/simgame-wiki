...
const MacBookAir2: FunctionComponent = () => {
  ...
  return (
    <div className="relative bg-darkslategray-100 w-full h-[832px] overflow-hidden text-left text-smi text-black font-inter">
      <div className="absolute top-[222px] left-[calc(53%_-_427px)] bg-white w-[333px] h-[482px] overflow-hidden">
        ...
        <div
          className="absolute top-[calc(50%-_171px)] left-[calc(50%-_141.5px)] font-medium cursor-pointer"
          onClick={onNAVIGATIONTABS1Click}
        >
          NAVIGATION TABS (1)
        </div>
        <div
          className="absolute top-[calc(50%-_137px)] left-[calc(50%-_141.5px)] font-medium cursor-pointer"
          onClick={onJUMBOTRON2TextClick}
        >
          JUMBOTRON (2)
        </div>
        <div
          className="absolute top-[calc(50%-_105px)] left-[calc(50%-_141.5px)] font-medium cursor-pointer"
          onClick={onPARAGRAPH2TextClick}
        >
          PARAGRAPH (2)
        </div>
        <div
          className="absolute top-[calc(50%-_74px)] left-[calc(50%-_141.5px)] font-medium inline-block w-[97px] h-[22px] cursor-pointer"
          onClick={onSTEPPER3TextClick}
        >
          STEPPER (3)
        </div>
        <div
          className="absolute top-[calc(50%-_41px)] left-[calc(50%-_141.5px)] font-medium cursor-pointer"
          onClick={onPROBLEMTROUBLESHOOTINGClick}
        >
          PROBLEM / TROUBLESHOOTING (4)
        </div>
        <div
          className="absolute top-[calc(50%-_9px)] left-[calc(50%-_141.5px)] font-medium inline-block w-[69px] h-[21px] cursor-pointer"
          onClick={onTABLE3TextClick}
        >
          TABLE (3)
        </div>
        <div
          className="absolute top-[calc(50%+_23px)] left-[calc(50%-_141.5px)] font-medium cursor-pointer"
          onClick={onBOTTOMNAVIGATION1Click}
        >{`BOTTOM NAVIGATION (1) `}
        
        </div>

        <div className="absolute top-[calc(50%+_55px)] left-[calc(50%-_141.5px)] font-medium inline-block w-[141px] h-[21px] cursor-pointer"
        onClick={onBREADCRUMBSTextClick}
        >
          BREADCRUMBS (1)
        </div>
        <div
          className="absolute top-[calc(50%+_86px)] left-[calc(50%-_141.5px)] font-medium inline-block w-[141px] h-[21px] cursor-pointer"
          onClick={onACCORDION3TextClick}
        >
          ACCORDION (3)
        </div>
        <div
          className="absolute top-[calc(50%+_118px)] left-[calc(50%-_141.5px)] font-medium inline-block w-[141px] h-[21px] cursor-pointer"
          onClick={onMENU1TextClick}
        >
          MENU (1)
        </div>
        <div
          className="absolute top-[calc(50%+_150px)] left-[calc(50%-_141.5px)] font-medium inline-block w-[141px] h-[21px] cursor-pointer"
          onClick={onIMPORTANTFACT1Click}
        >
          IMPORTANT FACT (1)
        </div>
        <div
          className="absolute top-[calc(50%+_182px)] left-[calc(50%-_141.5px)] font-medium inline-block w-[141px] h-[21px] cursor-pointer"
          onClick={onCALCULATOR1TextClick}
        >
          CALCULATOR (1)
        </div>
      </div>
      <div className="absolute top-[222px] right-[calc(53%_-_427px)] bg-white w-[325px] h-[482px] overflow-hidden">
        ...
        <div
          className="absolute top-[calc(50%-_171px)] left-[calc(50%-_137.5px)] font-medium cursor-pointer"
          onClick={onLANDINGPAGETextClick}
        >
          LANDING PAGE
        </div>
        <div
          className="absolute top-[calc(50%-_144px)] left-[calc(50%-_137.5px)] font-medium cursor-pointer"
