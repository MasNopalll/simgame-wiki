  ...
  return (
    <div className="relative bg-darkslategray-100 w-full h-[832px] overflow-hidden text-left text-mini text-silver-100 font-inter">
      ...
      <div className="absolute top-[53px] left-[592px] bg-gray-200 w-[270px] h-[700px] overflow-hidden">
        ...
        <div className="absolute top-[calc(50%_-_218px)] left-[calc(50%_-_115px)] mix-blend-normal">
          How to play
        </div>
        <div
          className="absolute top-[99px] left-[244px] cursor-pointer"
          onClick={onTextClick}
        >{`>`}</div>
        <div className="absolute top-[132px] left-[244px]">{`>`}</div>
      </div>
